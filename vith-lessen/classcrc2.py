class PehaCRC:
    def __init__(mysillyobject, inputstring, calcCRC0_findCRC1=None):
        mysillyobject.string_inputstring = inputstring.upper().rstrip().lstrip()
        mysillyobject.string_outputstring = mysillyobject.crcberekenen()
        mysillyobject.list_cmd_met_crc = mysillyobject.string_outputstring.split()
        if calcCRC0_findCRC1:
            print("zoeken naar crc")
    ...
    def waarissie(mysillyobject):
        ...
        for elementen, new_val in enumerate(tabel):
            ...
            if vastewaarden == listtemp:
                ...
                mysillyobject.string_outputstring =" ".join(listtemp)
                mysillyobject.string_inputstring = " ".join(mysillyobject.list_cmd_met_crc)
...
#object1 = PehaCRC("ff 01 01") #werkt
#p1 = PehaCRC("cc").crcberekenen()  # reken crc uit werkt

#zoek = PehaCRC("45 81 06 25 09 45 82" ,1  ).crcberekenen()  # reken crc uit
zoekopbject = PehaCRC("45 81 06 25 09 45 82" ,1  )  # reken crc uit
